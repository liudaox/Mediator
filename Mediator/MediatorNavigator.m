...
@implementation MediatorNavigator

+(MediatorNavigator *)navigator{
    static MediatorNavigator *rootNavigator = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        if (rootNavigator == nil) {
            rootNavigator = [[MediatorNavigator alloc] init];
        }
    });
...
@implementation MediatorNavigator (HookRouteBlock)
